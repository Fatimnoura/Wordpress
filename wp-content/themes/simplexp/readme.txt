...
A custom widget can easily be added in the SimpleXP footer.

SimpleXP comes with some patterns that allow for quick creation of content on pages and offer
the possibility of being customized to your needs and taste in just few steps.

SimpleXP has a set of custom icons that are fully integrated and usable directly from the block editor.
The icons are as follows: (.icon-phone .icon-envelope .icon-x .icon-clock-o .icon-calendar .icon-codepen
.icon-linkedin .icon-github .icon-youtube-play .icon-instagram .icon-whatsapp .icon-facebook .icon-map
.icon-map-marker .icon-chevron-up .icon-chevron-down .icon-chevron-left .icon-chevron-right .icon-code
.icon-line-chart .icon-briefcase .icon-wrench .icon-globe .icon-shield)
